    ...
    <header class="header">
      ...
      <div class="wrapper">
        <nav class="header__nav">
          ...
          <a href="https://www.linkedin.com/in/eamon-andrew-napier-b9980738b/" class="header__social linkedin">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="25"
              height="24"
    ...
    <main id="main">
      ...
      <section id="contact" class="contact bg-less-dark">
        <div class="wrapper contact__wrapper bottom-border">
          ...
          <form action="./formhandler.php" class="contact__form" method = "post">
